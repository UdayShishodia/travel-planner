...
import { Bars3Icon, ChatBubbleLeftIcon, PaperAirplaneIcon, SpeakerXMarkIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
import { PhoneIcon, PlayCircleIcon } from "lucide-react";
        ...
        <PopoverGroup className=" hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
                ...
                >
                    ...
                    top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl
            ...
            <a href="#" className="text-sm font-semibold leadinf-6 text-white">
                flights
            </a>
            <a href="#" className="text-sm font-semibold leadinf-6 text-white">
                Car Rentals
        ...
        >
            ...
            <div className="mt-6 flow-root">
                ...
                <div className="py-6">
                    <a 
                    href="#"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leasing-7 text-white
                    hover-bg-blue-800"
                    >
                        Log in
                    </a>
